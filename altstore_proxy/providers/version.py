...
def create_version_file():
    ...
    version_info = [
        ...
        "        StringStruct(u'FileDescription', u'AltStore-Proxy'),",
        "        StringStruct(u'FileVersion', u'" + str(int(version_split[0])) + "." + str(
            int(version_split[1])) + "." + str(int(version_split[2])) + "." + str(int(suffix)) + "'),",
        "        StringStruct(u'InternalName', u'AltStore-Proxy'),",
        "        StringStruct(u'LegalCopyright', u'Copyright © RiX'),",
        "        StringStruct(u'OriginalFilename', u'AltStore-Proxy.exe'),",
        "        StringStruct(u'ProductName', u'AltStore-Proxy'),",
